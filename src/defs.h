...
extern void _shttpd_get_mime_type (struct shttpd_ctx *, const char *, int, struct vec *);
...
extern struct registered_uri *_shttpd_is_registered_uri (struct shttpd_ctx *, const char *uri);
